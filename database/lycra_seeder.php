...
$lycra = array(
	array ('user_id'=>3, 'type'=>'pants', 'size'=>'medium', 'color'=>'multiple neaon', 'animal_stripe'=>'all of them', 'item_description'=>'During my brief reprieve from Sabbath, I thought about joining one of those L.A. hair bands. I bought these in anticipation, but luckily never got an opportunity to wear them.', 'price'=>50, 'trade'=>1, 'image_url'=>'/img/uploads/lyc_pants.jpg'),
	array ('user_id'=>7, 'type'=>'vest', 'size'=>'too tight', 'color'=>'black and white', 'animal_stripe'=>'no', 'item_description'=>'Won this at a stip poker game from one of the guys from Quiet Riot; found it in an old tour bag recently, and wanted to get rid of it ASAP.', 'price'=>10, 'trade'=>1, 'image_url'=>'/img/uploads/lyc_vest.jpg'),
	array ('user_id'=>5, 'type'=>'gloves', 'size'=>'medium', 'color'=>'', 'animal_stripe'=>'no', 'item_description'=>'Scary skeleton hands; good for drummers, vocalists... maybe even a bassist.', 'price'=>50, 'trade'=>0, 'image_url'=>'/img/uploads/lyc_glove.jpg'),
	array ('user_id'=>1, 'type'=>'unisuit', 'size'=>'medium', 'color'=>'black and yellow', 'animal_stripe'=>'bumble bee', 'item_description'=>'Unisuit from Stryper... any takers? Please?', 'price'=>30, 'trade'=>1, 'image_url'=>'/img/uploads/lyc_unisuit.jpg')
);
