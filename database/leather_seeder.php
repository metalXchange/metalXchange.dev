...
$leather = array(
	array ('user_id'=>1, 'type'=>'pants', 'headline'=>'Heavy Metal Chic', 'size'=>'32 inseam', 'color'=>'black', 'spikes'=>'None, but some nice buckles', 'item_description'=>'These were some pants that Sharon bought for me, but I\'m too boomin\' fat to wear them. I think she knew all along...', 'price'=>300, 'trade'=>1, 'trade_desc'=>'I\'d pretty much take anything...', 'image_url'=>'/img/uploads/lth_ozzy_pants.jpg'),
	array ('user_id'=>5, 'type'=>'vest', 'headline'=>'A piece of history...', 'size'=>'small', 'color'=>'black', 'spikes'=>'nope', 'item_description'=>'Backup vest from the 1983 tour.', 'price'=>150, 'trade'=>1, 'trade_desc'=>'I was looking for some \'84 Jordans...', 'image_url'=>'/img/uploads/lth_RJD_vest.jpg'),
	array ('user_id'=>5, 'type'=>'codpiece', 'headline'=>'Step up to Macho!', 'size'=>'xtra-large', 'color'=>'silver', 'spikes'=>'not that location', 'item_description'=>'Had an assistant arrange to have this made for me; he got the size wrong.', 'price'=>200, 'trade'=>1, 'trade_desc'=>'Not sure... make me an offer.', 'image_url'=>'/img/uploads/lth_RJD_codpiece.jpg'),
	array ('user_id'=>6, 'type'=>'boots', 'headline'=>'Not Nancy Sinatra\'s...', 'size'=>'10 narrow', 'color'=>'black', 'spikes'=>'you betcha', 'item_description'=>'Back-up boots... never really fit my style.', 'price'=>500, 'trade'=>0, 'trade_desc'=>'', 'image_url'=>'/img/uploads/lth_boots.jpeg')
);
